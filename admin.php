  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="siswa.php">
        ...
        <div class="sidebar-brand-text mx-3">Aplikasi PPDB</div>
      </a>
      ...
      <!-- Nav Item - Tables -->
      <li class="nav-item">
        <a class="nav-link" href="?menu=datsis">
      ...
      <li class="nav-item">
        <a class="nav-link" href="?menu=laporan">
          <i class="fas fa-fw fa-table"></i>
          <span>Laporan Data Siswa</span></a>
      </li>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Admin</a>
